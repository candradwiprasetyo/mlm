...
<html>
    <head>
        <meta charset="UTF-8">
        <title><?= ucwords($data_head['title']) ?> | Administrator IOB</title>
    ...
    <body class="skin-blue">
        ...
        <header class="header">
           ...
           <div style="font-weight:bold; text-align:center;">IOB</div>
               <div style="font-size:12px; font-weight:bold; color:#ccc; text-align:center">Your Business Solution</div>
